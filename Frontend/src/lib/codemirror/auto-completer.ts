...
export function getAutoCompletions(context: CompletionContext) {
...
function findNodesOfType(context: CompletionContext, typeName: string) {
    let tree = syntaxTree(context.state);
    let nodes: Array<any> = [];

    // Traverses every node of the tree.
    function preorderTraversal(cursor: TreeCursor) {
