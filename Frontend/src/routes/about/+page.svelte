...
<Section color="yellow">
	<div class="text-center">
		<AboutHeader1 class="pb-4">The Bird Programming Language</AboutHeader1>
	</div>
</Section>
...
<Section color="yellow">
	...
	<AboutText2>The “Dragon Book” has long been regarded as the definitive text on compilers. It provides information on all steps of the compilation process and the importance of design. The book's first edition was published in 1986 and has since remained a staple in the field of compiler design.</AboutText2>
	<AboutText2>(Aho, A. V., Lam, M. S., Sethi, R., & Ullman, J. D. (2007). Compilers: Principles, techniques, and Tools. Pearson Addison-Wesley. )</AboutText2>

	<AboutHeader3 class="pt-10">Websites</AboutHeader3>
	<AboutText2>Language Implementation: WebAssembly</AboutText2>
	<AboutText2>This website is a great tutorial for learning more about WebAssembly. It talks about how to code in WebAssembly and how to use JavaScript with it.</AboutText2>
	<AboutText2>https://openhome.cc/eGossip/WebAssembly/index.html</AboutText2>

	<AboutHeader3 class="pt-10">Articles</AboutHeader3>
	<AboutText2>An Empirical Study of Bugs in WebAssembly Compilers</AboutText2>
	<AboutText2>In this article, the authors analyze bug reports in compilers such as Emscripten, AssemblyScript, and Rustc/Wasm-Bindgen. They hope this research will lead to the development of more practical tools for testing and debugging WebAssembly compilers. The authors presented nine conclusions about the WebAssembly compiler bugs.</AboutText2>
	<AboutText2>Romano, Alan, et al. “An Empirical Study of Bugs in WebAssembly Compilers.” 2021 36th IEEE/ACM International Conference on Automated Software Engineering (ASE), 1 Nov. 2021, https://doi.org/10.1109/ase51524.2021.9678776</AboutText2>
</Section>
